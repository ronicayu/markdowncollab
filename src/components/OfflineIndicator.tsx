...
export default function OfflineIndicator() {
  ...
  return (
    <div className="fixed bottom-4 left-1/2 -translate-x-1/2 z-50 flex items-center gap-2 bg-amber-600 text-white px-4 py-2 rounded-lg shadow-lg text-sm font-medium">
